...
public class SettingsPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JLabel sub = new JLabel("Manage your profile and preferences");
    ...
    private JPanel profileCard() {
        ...
        JLabel role = new JLabel("User Account");
    ...
    private JPanel preferences() {
        ...
        card.add(new JCheckBox("Booking Reminders", true));
        card.add(new JCheckBox("Promotional Offers"));
